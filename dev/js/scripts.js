...
function dropG(){
    ...
    tl.from(".upper", {duration: 1, ease: "power4.out", scaleY:0, transformOrigin: "top center"}, "try");
    tl.from(".lower", {duration: 1, ease: "power4.out", scaleY:0, transformOrigin: "bottom center"}, "try");
    tl.from("#First-Left-Small, #First-Right-Small", {duration: .01, autoAlpha:0});
    tl.to("#First-Left-Small", {duration: 2, ease: "back.out(1.7)", delay: .75, morphSVG:"#Left-Ellipse"}, "trying");
    tl.to("#First-Right-Small", {duration: 2, ease: "back.out(1.7)", delay: .75, morphSVG:"#Right-Ellipse"}, "trying");
...
function morphEllipseLeft(){
    ...
    tl.to("#Left-Ellipse", {duration: 1, ease: "back.out(1.7)", y:"-=250", morphSVG:"#Left-Ellipse"});
    tl.to("#Left-Ellipse", {duration: 0.5, y:"+=70"});
...
function morphEllipseRight(){
    ...
    tl.to("#Right-Ellipse", {duration: 1, ease: "back.out(1.7)", y:"+=250", morphSVG:"#Right-Ellipse"});
    tl.to("#Right-Ellipse", {duration: 0.5, y:"-=70"});
...
function ellipseLeftEnd(){
    ...
    tl.to("#Left-Ellipse-2", {duration: 2, ease: "power4.out", y:"+=200", morphSVG:"#Left-Surfboard-Third"});
    return tl;
}
...
function ellipseRightEnd(){
    ...
    tl.to("#Right-Ellipse-2", {duration: 2, ease: "power4.out", y:"-=200", morphSVG:"#Right-Surfboard-Third"});
    return tl;
}
